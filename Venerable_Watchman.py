...
def createFirst():
	print("Processing...")
	selectedRange = copyRange(1,1,18,row_count,source) #Change the 4 number values
	pastingRange = pasteRange(1,1,18,row_count,target,selectedRange) #Change the 4 number values
